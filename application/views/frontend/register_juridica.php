		...
		<h3>identificação</h3>
		 ...
		 <!-- Form -->
				<div class="sky_form">
					<ul>
						<li>
							<form id="registration_form" action="<?php  site_url('Register/viewCadastro') ?>" method="post">
							<label onclick="this.form.submit();" class="radio left"><input type="radio" name="radio" value="1" ><i>Pessoa Física</i></label>
							</form>
						</li>
						<li>
							<form id="registration_form" action="" method="post">
							<label onclick="this.form.submit();" class="radio"><input type="radio" name="radio" checked="" value="2"><i>Pessoa Jurídica</i></label>
							</form>
						</li>
					</ul>
				</div>
        <?php echo form_open('Register/cadastrarJuridica') ?>
          ...
          <input name="nome"  placeholder="Razão Social" type="text" tabindex="1" required="" autofocus="">
				</div>
				<div>
					<label>
            E-mail
          ...
          <input name="cnpj" placeholder="Digite apenas números" type="text"  maxlength="14" OnKeyPress="formatar('###.###.###-##', this)" tabindex="5" required="">
				</div>
				<div>
					<label>
            Inscrição Estadual
					</label>
          <input name="inscEstadual" placeholder="Digite apenas números" type="text"  maxlength="10	" OnKeyPress="formatar('##/##/####', this)" tabindex="6" required="">
				</div>
