...
<div class="wrap">
	<div class="header">
		<div class="logo">
			<a href="<?php echo base_url('home_dashboard') ?>"><img src="<?php echo base_url();?>assets/frontend/web/images/logo.png" alt=""/></a>
		</div>
		 <div class="log_reg">
			...
			<?php } else { ?>
				<ul>
					<li><a href="<?php echo base_url('home/login') ?>"title="Entre ou cadastre-se"> <img "<?php echo base_url();?>assets/frontend/web/images/usericon.png" align="left">
	...
	<div class="header_btm">
		...
		<div class="menu collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" role="button" href="<?php echo base_url('produto_dashboard') ?>">Produtos<span class="caret"></span> </a>
					<ul class="dropdown-menu">

						<?php foreach ($produtos as $produto) { ?>

							<li>
								<a href="<?php echo base_url('produto_dashboard/'.$produto->idproduto.'/'.limpar($produto->descricao)) ?>"><?php echo $produto->descricao ?></a>
							</li>
